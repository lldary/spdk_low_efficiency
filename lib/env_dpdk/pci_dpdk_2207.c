...
static int
pci_device_control_spec_interrupt_2207(struct rte_pci_device *rte_dev, uint32_t index, bool enable)
{
...
struct dpdk_fn_table fn_table_2207 = {
	...
	.pci_device_control_spec_interrupt = pci_device_control_spec_interrupt_2207,
