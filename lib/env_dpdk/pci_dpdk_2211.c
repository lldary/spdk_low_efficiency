...
static int
pci_device_enable_spec_interrupt_2211(struct rte_pci_device *rte_dev, uint32_t index)
{
...
static int
pci_device_create_interrupt_efds_uintr_2211(struct rte_pci_device *rte_dev, uint32_t index)
{
