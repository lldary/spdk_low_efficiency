							  ...
							  const struct spdk_nvme_io_qpair_opts *opts)
{
	...
	if (pqpair->tr == NULL)
	{
		...
		SPDK_ERRLOG("Failed to allocate %zu bytes for nvme_tracker\n",
					num_trackers * sizeof(*tr));
		return -ENOMEM;
	}
...
void nvme_pcie_poll_group_check_disconnected_qpairs(struct spdk_nvme_transport_poll_group *tgroup,
...
nvme_pcie_trace(void)
{
	struct spdk_trace_tpoint_opts opts[] = {
		{"NVME_PCIE_SUBMIT", TRACE_NVME_PCIE_SUBMIT, OWNER_TYPE_NVME_PCIE_QP, OBJECT_NVME_PCIE_REQ, 1, {{"ctx", SPDK_TRACE_ARG_TYPE_PTR, 8}, {"cid", SPDK_TRACE_ARG_TYPE_INT, 4}, {"opc", SPDK_TRACE_ARG_TYPE_INT, 4}, {"dw10", SPDK_TRACE_ARG_TYPE_PTR, 4}, {"dw11", SPDK_TRACE_ARG_TYPE_PTR, 4}, {"dw12", SPDK_TRACE_ARG_TYPE_PTR, 4}, {"qd", SPDK_TRACE_ARG_TYPE_INT, 4}}},
		{"NVME_PCIE_COMPLETE", TRACE_NVME_PCIE_COMPLETE, OWNER_TYPE_NVME_PCIE_QP, OBJECT_NVME_PCIE_REQ, 0, {{"ctx", SPDK_TRACE_ARG_TYPE_PTR, 8}, {"cid", SPDK_TRACE_ARG_TYPE_INT, 4}, {"cpl", SPDK_TRACE_ARG_TYPE_PTR, 4}, {"qd", SPDK_TRACE_ARG_TYPE_INT, 4}}},
	};
